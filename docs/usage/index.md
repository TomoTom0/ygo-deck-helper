...
遊戯王カードデータベースのデッキ管理を支援するChrome拡張の使い方を画面>機能の構造で説明します。
...
デッキ編集ページは独立した統合UIで、カード検索・デッキ編集・カード詳細確認を一画面で行えます。

**詳細**: [デッキ編集機能ガイド](./deck-edit.md) を参照してください。
...
#### 機能: テストページへのアクセス
- 拡張機能の全API機能をテストできる開発者向けページを開きます
- テストページURL: `https://www.db.yugioh-card.com/yugiohdb/#/ytomo/test`

#### バージョン情報
- 現在インストールされている拡張機能のバージョンが表示されます

**NOTE**: デッキ編集設定・多言語設定などのユーザー設定UIは今後のバージョンで追加予定です。
